...
// Build the QR image URL via a free public QR image API — no library/Composer needed
$qr_image = null;
if ($qr && !empty($qr['qr_token'])) {
  $qr_image = 'https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=' . urlencode($qr['qr_token']);
}
